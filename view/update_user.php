                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form id="edit_user">
                                            <input type="text" id="uid" name="uid" value="<?php echo $_GET['uid']; ?>" required hidden>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="text" class="form-control" id="name" name="name" aria-label="John Doe" aria-describedby="name" autocomplete="off" value="<?php echo $_GET['name']; ?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <select id="gender" name="gender" class="form-select">
                                                            <option value="1" <?php echo ($_GET['gender'] == 1) ? "selected" : ""; ?>>Male</option>
                                                            <option value="2" <?php echo ($_GET['gender'] == 2) ? "selected" : ""; ?>>Female</option>
                                                        </select>
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="date" class="form-control" id="dob" name="dob" value="<?php
                                                                                                                            $inputDateString = $_GET['date_of_birth'];
                                            ...
                                            <div class=" row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="email" class="form-control" id="email" name="email" autocomplete="off" value="<?php echo $_GET['email']; ?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="password" class="form-control" id="password" name="password" autocomplete="off" value="<?php echo $_GET['password']; ?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        <span class="input-group-text"><i class="bx bx-key"></i></span>
                                                        <input type="password" class="form-control" id="copassword" name="copassword" autocomplete="off" value="<?php echo $_GET['password']; ?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <select id="role" name="role" class="form-select" required>
                                                            <option value="2" <?php echo ($_GET['role'] == 2) ? "selected" : ""; ?>>Home User</option>
